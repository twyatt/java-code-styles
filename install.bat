REM Installs PAX's IntelliJ configs into your user configs.
@echo off
echo Installing PAX IntelliJ configs...
...
echo.
echo Restart IntelliJ and/or AndroidStudio, go to preferences, and apply 'Pax' or 'PaxAndroid'.
exit /b
